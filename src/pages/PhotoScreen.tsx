...
import { ArrowLeft, Image, ChevronLeft } from 'lucide-react';
...
function openGallery(platform: Platform | null) {
      ...
      <header className="px-4 pt-6 pb-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            {platform && (
              <button onClick={() => setPlatform(null)} className="flex items-center gap-0.5 text-pink-500" style={{ fontSize: '14px' }}>
                <ChevronLeft size={14} />
          ...
          {!platform ? (
            ...
            >
              <div className="bg-pink-50 border border-pink-200 rounded-2xl p-4">
                <p className="text-pink-800 font-semibold" style={{ fontSize: '19px' }}>
                  내 스마트폰 종류를 골라주세요
                </p>
                <p className="text-pink-600 mt-1" style={{ fontSize: '15px' }}>
                  기기에 맞는 설명을 보여드릴게요.
                </p>
              </div>
            ...
            <motion.div
              ...
              className="space-y-4"
            >
              <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} className="bg-pink-50 border border-pink-200 rounded-2xl p-4">
                <p className="text-pink-800 font-semibold leading-relaxed" style={{ fontSize: '19px' }}>
                  {platform === 'android' ? '갤러리(사진) 앱' : 'iPhone 사진 앱'}을 사용하는 방법이에요.
                </p>
              </motion.div>
              ...
              <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.5 }} className="bg-blue-50 border border-blue-200 rounded-2xl p-4">
